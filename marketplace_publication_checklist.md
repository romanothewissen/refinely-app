...
- [ ] **External Fetch URLs**: Your current addresses are `https://generativelanguage.googleapis.com` and `https://api.openai.com`. Ensure these are correct and note them for the Marketplace submission (you'll need to explain why they are used).
...
- [ ] **Privacy Policy**: A public link explaining how you handle user data (especially important since you use external LLM providers).
- [ ] **Terms of Service**: Your end-user license agreement (EULA).
