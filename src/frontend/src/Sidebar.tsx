...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="px-5 py-4 bg-white flex items-center justify-between shrink-0"
      ...
      <div className="flex-1 min-h-0 flex flex-col w-full px-4 py-4 gap-3.5 overflow-y-auto no-scrollbar">
